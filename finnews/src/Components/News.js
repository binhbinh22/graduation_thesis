    ...
    return (
        <div>
            ...
            <div style={{ display: 'flex' }}>
                <div className="general-news-section" style={{ width: '70%', paddingLeft: '50px' }}>
                    <h2>Tin tức chung</h2>
                    {news.map(item => (
                        <div key={item.id} className="news-link" onClick={() => handleNewsClick(item.id)}>
                            <div className="news-item" style={{ width: '800px' }}>
                                ...
                                <div className="news-item-content" style={{ flex: 1 }}>
                                    <p style={{ margin: 0, fontSize: '0.8rem', color: 'gray' }}>{item.topic}</p>
                                    <h3 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 'bold' }}>{item.title}</h3>
                                    <p style={{ margin: 0, fontSize: '0.8rem', color: 'gray' }}>{item.time}</p>
                ...
                <div className="featured-news-section" style={{ width: '30%', paddingLeft: '20px' }}>
                    <h2>Tin nổi bật</h2>
                    {featuredNews.map(item => (
                        <div key={item.id} className="featured-news-item" onClick={() => handleNewsClick(item.id)}>
                            <h3>{item.title}</h3>
                        </div>
                    ))}
                </div>
